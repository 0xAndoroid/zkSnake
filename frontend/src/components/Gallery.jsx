...
const Gallery = (props) => {
  ...
  const fetchCollection = async () => {
    ...
    try {
      ...
      const provider = new ethers.providers.JsonRpcProvider("https://wider-powerful-fog.ethereum-sepolia.quiknode.pro/ff66a7f93b85f72214a4d0344a8eb2d6305be1ca/");
  ...
  return (
    <div className='container mx-auto mb-8'>
     ...
     {finished && <p className="text-center">You've reached the end of the collection.</p>}

        {!finished && <div className="flex justify-center mt-4">
          <button
